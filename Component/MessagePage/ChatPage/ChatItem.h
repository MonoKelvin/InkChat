...
public:
    ...
    inline void fromSenderData(const SUserChatData& data) noexcept
    {
        mData = QVariant::fromValue(data);
    }

    const SUserChatData getSenderData() const noexcept;
