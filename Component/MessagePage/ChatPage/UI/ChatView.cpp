    ...
    : QListWidget(parent)
{
    ...
    for (int j = 0; j< 20; j++) {
        ...
        addChatWidget(new ChatItem(u, s, IChatItem::ESender::Ta));
...
ChatView::ChatView(QSharedPointer<User> user, QWidget* parent)
{

}

void ChatView::addChatWidget(IChatItem* chat, bool isScrollToBottom)
{
    if (chat)
    {
        chat->setParent(this);
...
void ChatView::setHeaderTitle(const QString& title)
{
    mHeaderTitle->setText(title);
}

void ChatView::clearChats()
{
    const int c = count();
