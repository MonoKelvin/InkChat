...
public:
     ...
     */
    Q_INVOKABLE inline int getRow(MessageItem* message) const
    {
     ...
     * @param to 目的行索引
     */
    Q_INVOKABLE void moveMessage(int from, int to);
     ...
     */
    Q_INVOKABLE void setMessageTop(MessageItem* message, bool isTop = true, bool moveToBottom = false);
...
protected:
     ...
     */
    Q_INVOKABLE void setCurrentSelectedIndex(int index);

    /**
     * @brief 获得当前选中的item的索引
     * @return int 选中item的索引
     */
    Q_INVOKABLE int getCurrentSelectedIndex(void);
